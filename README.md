...
│
├── palettes.json              ← Master file: all palettes with full metadata
│
├── temperature/
│   ├── README.md
│   ├── thermo_classic.json
...
├── elevation/
│   ├── README.md
│   ├── terrain_natural.json
│   ├── bathymetry.json
│   └── hypsometric_tint.json
│
├── wind/
│   ├── README.md
│   ├── wind_speed.json
...
├── seismicity/
│   ├── README.md
│   └── seismic_intensity.json
│
└── index.html                 ← Interactive web app (GeoPalettes explorer)
```
